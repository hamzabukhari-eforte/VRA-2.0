...
export default function FacilityImageCarousel({
  ...
  // We need enough duplicates so the loop is seamless
    ...
    <section className="w-full overflow-hidden">
      ...
      <div ref={containerRef} className="flex animate-scroll gap-2 md:gap-4">
        {duplicatedImages.map((image, index) => {
          // Fixed height for all images, width based on actual aspect ratio
          const fixedHeight = 300;
          const aspectRatio = image.width / image.height + 0.5;
